...
import { View, Text, Button, StyleSheet, Alert, Image, ScrollView, TextInput, TouchableOpacity } from 'react-native';
...
const DisplayDataPage = ({ navigation }) => {
  ...
  return (
   ...
   {userData == null && <View style={{ marginBottom: 20 }}>
...
{userData && (
  <ScrollView style={styles.scannedDataContainer}>
    <Text><Text style={styles.bold}>First Name:</Text> {userData.fname}</Text>
